 ...
 * \file
 *
 * \brief Header file for SAMD21E15CU
 *
...
#ifndef _SAMD21E15CU_
#define _SAMD21E15CU_

/**
 * \ingroup SAMD21_definitions
 * \addtogroup SAMD21E15CU_definitions SAMD21E15CU definitions
...
/* ************************************************************************** */
/** \defgroup SAMD21E15CU_cmsis CMSIS Definitions */
/*@{*/
...
typedef enum IRQn
{
  ...
  PM_IRQn                  =  0, /**<  0 SAMD21E15CU Power Manager (PM) */
  SYSCTRL_IRQn             =  1, /**<  1 SAMD21E15CU System Control (SYSCTRL) */
  WDT_IRQn                 =  2, /**<  2 SAMD21E15CU Watchdog Timer (WDT) */
  RTC_IRQn                 =  3, /**<  3 SAMD21E15CU Real-Time Counter (RTC) */
  EIC_IRQn                 =  4, /**<  4 SAMD21E15CU External Interrupt Controller (EIC) */
  NVMCTRL_IRQn             =  5, /**<  5 SAMD21E15CU Non-Volatile Memory Controller (NVMCTRL) */
  DMAC_IRQn                =  6, /**<  6 SAMD21E15CU Direct Memory Access Controller (DMAC) */
  USB_IRQn                 =  7, /**<  7 SAMD21E15CU Universal Serial Bus (USB) */
  EVSYS_IRQn               =  8, /**<  8 SAMD21E15CU Event System Interface (EVSYS) */
  SERCOM0_IRQn             =  9, /**<  9 SAMD21E15CU Serial Communication Interface 0 (SERCOM0) */
  SERCOM1_IRQn             = 10, /**< 10 SAMD21E15CU Serial Communication Interface 1 (SERCOM1) */
  SERCOM2_IRQn             = 11, /**< 11 SAMD21E15CU Serial Communication Interface 2 (SERCOM2) */
  SERCOM3_IRQn             = 12, /**< 12 SAMD21E15CU Serial Communication Interface 3 (SERCOM3) */
  TCC0_IRQn                = 15, /**< 15 SAMD21E15CU Timer Counter Control 0 (TCC0) */
  TCC1_IRQn                = 16, /**< 16 SAMD21E15CU Timer Counter Control 1 (TCC1) */
  TCC2_IRQn                = 17, /**< 17 SAMD21E15CU Timer Counter Control 2 (TCC2) */
  TC3_IRQn                 = 18, /**< 18 SAMD21E15CU Basic Timer Counter 3 (TC3) */
  TC4_IRQn                 = 19, /**< 19 SAMD21E15CU Basic Timer Counter 4 (TC4) */
  TC5_IRQn                 = 20, /**< 20 SAMD21E15CU Basic Timer Counter 5 (TC5) */
  ADC_IRQn                 = 23, /**< 23 SAMD21E15CU Analog Digital Converter (ADC) */
  AC_IRQn                  = 24, /**< 24 SAMD21E15CU Analog Comparators  (AC) */
  DAC_IRQn                 = 25, /**< 25 SAMD21E15CU Digital Analog Converter (DAC) */
  PTC_IRQn                 = 26, /**< 26 SAMD21E15CU Peripheral Touch Controller (PTC) */
  I2S_IRQn                 = 27, /**< 27 SAMD21E15CU Inter-IC Sound Interface (I2S) */
...
/* ************************************************************************** */
/**  SOFTWARE PERIPHERAL API DEFINITION FOR SAMD21E15CU */
/* ************************************************************************** */
/** \defgroup SAMD21E15CU_api Peripheral Software API */
/*@{*/
...
/* ************************************************************************** */
/**  REGISTERS ACCESS DEFINITIONS FOR SAMD21E15CU */
/* ************************************************************************** */
/** \defgroup SAMD21E15CU_reg Registers Access Definitions */
/*@{*/
...
/* ************************************************************************** */
/** \defgroup SAMD21E15CU_id Peripheral Ids Definitions */
/*@{*/
...
/* ************************************************************************** */
/** \defgroup SAMD21E15CU_base Peripheral Base Address Definitions */
/*@{*/
...
/* ************************************************************************** */
/**  PORT DEFINITIONS FOR SAMD21E15CU */
/* ************************************************************************** */
/** \defgroup SAMD21E15CU_port PORT Definitions */
/*@{*/
...
#define DSU_DID_RESETVALUE    _UL_(0x10011563)
